...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/YiKepro/echoyinke.github.io/issues/15)
...
# SNS settings      
github_username: YiKepro     # 你的github账号
weibo_username: YiKepro      # 你的微博账号，底部链接会自动更新的。
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/YiKepro/echoyinke.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
